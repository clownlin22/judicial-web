Ext.define("Rds.judicial.panel.JudicialSampleManagementGridPanel", {
...
//                        }
    ...
    onCheck: function () {
        var me = this.up("gridpanel");
        var form = Ext.create(
            "Rds.judicial.panel.JudicialDataUploadCheckFormPanel", {
                region: "center",
                grid: me
            });
        var win = Ext.create("Ext.window.Window", {
    ...
    onInsert: function () {
        var me = this.up("gridpanel");
        var form = Ext.create(
            "Rds.judicial.panel.JudicialDataUploadFormPanel", {
                region: "center",
                grid: me
            });
        var win = Ext.create("Ext.window.Window", {
