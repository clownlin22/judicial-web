Ext.define("Rds.judicial.panel.JudicialCaseFeeGridPanelRemark", {
...
//					blankText:"不能为空", //错误提示信息，默认为This field is required! 
		...
		me.store = Ext.create('Ext.data.Store', {
			fields : [ 'case_id', 'fee_id', 'case_code', 'stand_sum',
					...
					'remark', 'type','oa_num',"areaname",'sample_str','confirm_date','paragraphtime','account',
...
'beforeedit':function(editor, e){
			if(e.record.data.status==0 || e.record.data.status==2 || !('subo_xuym' == usercode))
				return false;
		},
