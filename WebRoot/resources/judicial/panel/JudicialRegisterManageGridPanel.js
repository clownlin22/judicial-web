Ext
		.define(
				"Rds.judicial.panel.JudicialRegisterManageGridPanel",
				{
								...
								.create(
										'Ext.data.Store',
										{
											fields : [ 'case_id', 'case_code',
													...
													'sample_in_per','unit_type','sample_relation','case_type','agent'
													],
											proxy : {
												type : 'jsonajax',
												actionMethods : {
						...
						me.dockedItems = [
								{
									...
									dock : 'top',
									items : [
                                             case_code,receiver,client,is_delete,starttime,endtime
											, {
												text : '查询',
												iconCls : 'Find',
												handler : me.onSearch
									...
									items : [  {
										...
										text : '回退审核状态',
										iconCls : 'Pageexcel',
										handler : me.onReturnState
									}]
								} ];

						me.callParent(arguments);
					},
					onReturnState:function(){
						...
						.confirm(
								...
								function(id) {
									if (id == 'yes') {
										Ext.Ajax
												.request({
													url : "judicial/register/returnCaseInfoState.do",
													method : "POST",
													headers : {
					...
					onUpdate : function() {
						...
						var form = Ext.create(
								"Rds.judicial.form.JudicialRegisterManageUpdateForm", {
									region : "center",
									grid : me
								});
