 ...
 * @date 20150427
 */
Ext.define("Rds.judicial.panel.JudicialArchiveReadPanel", {
	...
	initComponent : function() {
		...
		me.store = Ext.create('Ext.data.Store', {
					fields : ['archive_id', 'archive_code', 'case_code',
							'archive_address', 'archive_date', 'archive_per','sample_archive_address'],
					start:0,
					limit:15,
					pageSize:15,
					proxy : {
						...
						url : 'judicial/archive/queryallpage.do',
						params : {},
						reader : {
							type : 'json',
							root : 'data',
		...
		me.columns = [{
					...
					text : '样本归档地址',
					dataIndex : 'sample_archive_address',
					width : '25%',
					menuDisabled : true,
					flex : 2
				},  {
		...
		var myGrid = Ext.create('Ext.grid.Panel', {
					...
					store : Ext.create('Ext.data.Store', {
								...
								proxy : {
									...
									url : 'judicial/archive/queryRead.do',
									params : {},
									reader : {
										type : 'json',
										root : 'data',
	...
	onSave : function() {
		...
		Ext.Ajax.request({
					url : "judicial/archive/readsave.do",
					method : "POST",
					headers : {
