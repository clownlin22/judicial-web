var exportParams;
Ext.define("Rds.judicial.panel.JudicialExportSichuanCaseInfoPanel", {
	...
	initComponent : function() {
		...
		var report_model = new Ext.form.field.ComboBox({
			...
			store : new Ext.data.ArrayStore({
						fields : ['Name', 'Code'],
						data : [['全部', ''],['曹县—泰安','cxjymodel'],['龙图鉴定', 'ltjdmodel'],['求实鉴定','qsjdmodel'],
		...
		me.store = Ext.create('Ext.data.Store', {
			fields : ['case_id', 'case_area', 'case_code', 'case_areacode','fandm','child',
					'receiver_area', 'case_receiver', 'accept_time','client','case_in_per',
					'close_time','real_sum','parnter_name','sample_in_per',
