...
Ext.define("Rds.judicial.panel.JudicialRegisterPCGridPanel",{
...
//						}
					...
					onSecondCase:function(){
						...
						if(null==selections[0].get("report_model"))
						{
							var form = Ext.create(
									"Rds.judicial.form.JudicialRegisterCaseSecondNoReptForm", {
										region : "center",
										autoScroll : true,
										grid : me
									});
							...
							var form = Ext.create(
									"Rds.judicial.form.JudicialRegisterCaseSecondForm", {
										region : "center",
										autoScroll : true,
										grid : me
									});
					...
					onCaseFill:function(){
						...
						if(selections[0].get("case_state")=='6' )
						{
							Ext.Msg.alert("提示", "该案例已是补样案例!");
							return;
						}
						ownpersonTemp=selections[0].get("case_userid") ;
						ownaddressTemp=selections[0].get("case_areacode") ;
						...
						{
							var form = Ext.create(
									"Rds.judicial.form.JudicialRegisterCaseFillNoReptForm", {
										region : "center",
										autoScroll : true,
										grid : me
									});
						...
						{
							var form = Ext.create(
									"Rds.judicial.form.JudicialRegisterCaseFillForm", {
										region : "center",
										autoScroll : true,
										grid : me
									});
					...
					onFindExpress:function(){
						...
						var case_id_del=selections[0].get("case_id");
...
//						}
					...
					onInsertOther:function(){
						...
						ownaddressTemp="";
						var form = Ext.create(
								"Rds.judicial.form.JudicialRegisterInserNoReptForm",
								{
									region : "center",
									autoScroll : true,
									grid : me
					...
					onInsert : function() {
						...
						ownaddressTemp="";
						var form = Ext.create(
								"Rds.judicial.form.JudicialRegisterCaseInsertForm",
								{
									region : "center",
									autoScroll : true,
									grid : me
...
//						}
						...
						ownpersonTemp=selections[0].get("case_userid") ;
						ownaddressTemp=selections[0].get("case_areacode") ;
						if(null == case_code || '' == case_code)
						{
							if(null==selections[0].get("report_model"))
							{
								var form = Ext.create(
										"Rds.judicial.form.JudicialRegisterUpdateNoReptForm", {
											region : "center",
											autoScroll : true,
											grid : me
										});
