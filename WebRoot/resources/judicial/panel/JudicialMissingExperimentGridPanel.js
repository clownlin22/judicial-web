Ext.define("Rds.judicial.panel.JudicialMissingExperimentGridPanel", {
    ...
    initComponent: function () {
        ...
        me.store = Ext.create('Ext.data.Store', {
            ...
            fields: ['case_code','sub_case_code','pi','parent1_pi','parent2_pi',
                'result','username1','username2','username3','unmatched_count','unmatched_node',
        ...
        me.columns = [
            ...
            {text: '不匹配基因',dataIndex:'unmatched_node',width: '10%'},
            {text: '目前总亲权指数',dataIndex:'pi',width: '10%'},
            {text: '亲权指数F',dataIndex:'parent1_pi',width: '8%'},
            {text: '亲权指数M',dataIndex:'parent2_pi',width: '8%'},
