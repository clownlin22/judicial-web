...
Ext.define("Rds.judicial.panel.JudicialPrintPanel", {
...
+"&print_count="+selections[0].get("print_count")+"&print="+print;
        var win = Ext.create("Ext.window.Window", {
            config:{
                gridpanel:me
            },
            ...
            modal:true,
            bodyStyle : "background-color:white;",
            html:"<iframe width=100% height=100% id='verifyWord1' src='"+src+"'></iframe>",
            buttons:[
                {
                    text : '取消',
                    iconCls : 'Arrowredo',
