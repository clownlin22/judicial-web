...
Ext.define('Rds.judicial.form.JudicialRegisterMedicalCaseFillNoReptForm', {
				...
				items : [	{
				     ...
				     ]},
				     {
							...
							items : [{
							        ...
							        {xtype:"hiddenfield",name:"case_type",value:"1"},
									{
										// 该列在整行中所占的百分比
										columnWidth : .50,
										xtype : "textfield",
...
//							}, 
							...
							items : [ typeid, Ext.create('Ext.form.field.Number',{
							    fieldLabel: "补样本数<span style='color:red'>*</span>",
							    name: 'per_num',
							    labelWidth : 80,
							    maxValue: 9999,
							    minValue: 0,
...
//														allowBlank : false,
	...
	onSaveSubmit:function(){
		...
		Ext.getCmp("case_state").setValue(6);
									...
									items : [{
												...
												name : 'sample_type',
												 listeners :{
							                        	"select" : function(combo, record, index){
							                        		var mei = this.up("form");
							                        		if( combo.getValue() == 'cy01' )
								                        		mei.getForm().findField('special').setValue('0');
							                        		else if(combo.getValue()== 'cy02' || combo.getValue()== 'cy03')
