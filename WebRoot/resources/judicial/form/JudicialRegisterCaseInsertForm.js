...
Ext.define('Rds.judicial.form.JudicialRegisterCaseInsertForm', {
...
//			}
			//判断身份证准确性，性别
//			if (!id_result) {
//				Ext.MessageBox.alert("错误信息","存在身份证信息不匹配的数据,性别不匹配！");
//				return;
//			}
			//判断称谓选错
...
//			}
			...
			console.log(father_num);

			console.log(mother_num);
