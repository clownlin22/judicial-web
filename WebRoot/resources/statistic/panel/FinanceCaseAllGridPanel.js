...
Ext.define("Rds.statistic.panel.FinanceCaseAllGridPanel",{
...
//		});
        ...
        me.store = Ext.create('Ext.data.Store',{
            ...
            proxy: {
                ...
                api:{
                    read:'statistics/personAmboea/queryCaseAllPage.do'
                },
                reader: {
                    type: 'json',
                    root:'data',
       ...
       var pagingToolbar=Ext.getCmp('pagingbarFinanceCaseAll');
        ...
        me.dockedItems = [{
			...
			name : 'search',
			dock : 'top',
			items : [ case_code,case_user,case_area,confirm_date_start,confirm_date_end]
		},{
			style : {
		        borderTopWidth : '0px !important',
		        borderBottomWidth : '0px !important'
			...
			name : 'search',
			dock : 'top',
			items : [ case_type,case_subtype,manageCostUnit,client,webchart]
		},{
			...
			name : 'search',
			dock : 'top',
			items : [ accept_time_start,accept_time_end,{
                text:'查询',
                iconCls:'Find',
                handler:me.onSearch
            },{
    ...
    onExport:function(){
        window.location.href = "statistics/personAmboea/exportCaseAll.do?"+FinanceStatistic
    },
    onSearch : function() {
