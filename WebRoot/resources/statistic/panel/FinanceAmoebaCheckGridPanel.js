Ext.define("Rds.statistic.panel.FinanceAmoebaCheckGridPanel",{
					...
					initComponent : function() {
						...
						var amoeba_deptment1 = Ext.create('Ext.form.field.Text', {
												...
												'beforeload' : function(ds,
													...
													Ext.apply(
															me.store.proxy.extraParams,{								
																...
																amoeba_deptment1:amoeba_deptment1.getValue()
															});
												}
											}
										});
				       ...
				       var pagingToolbar=Ext.getCmp('pagingbarAmoebaCheck');
						...
						me.dockedItems = [
								{
									...
									name : 'search',
									dock : 'top',
									items : [amoeba_program,amoeba_deptment,amoeba_deptment1,{
												text : '查询',
												iconCls : 'Find',
												handler : me.onSearch
											}]
