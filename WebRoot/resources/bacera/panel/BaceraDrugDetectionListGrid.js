var drugDetection="";
Ext.define('Rds.bacera.panel.BaceraDrugDetectionListGrid', {
	...
	initComponent : function() {
		...
		var partner = Ext.create('Ext.form.field.Text',{
        	name:'partner',
        	labelWidth:60,
        	width:'20%',
        	fieldLabel:'合作方'
...
//			forceSelection: true, 
		...
		me.store = Ext.create('Ext.data.Store',{
			fields:['id','num','name','partner','date','program','inputperson','inspection','entrusted_unit','sample_type',
			        'agentname','ownpersonname','ownperson','sample_count','confirm_flag','program_type',
            ...
            listeners:{
            	'beforeload':function(ds, operation, opt){
            		...
            		drugDetection = "num=" + search.getValue().trim() + 
            		                "&partner"+ partner.getValue().trim() + 
       ...
       var pagingToolbar=Ext.getCmp('pagingbarDrugDetection');
...
//	   	 	emptyMsg : "没有符合条件的记录"
//        });
		//me.bbar = {xtype: 'label',id:'totalBbar_drugDetection', text: '',style:'height:25px;line-height:25px;text-align:right;margin-right:10px;'};
		me.columns = [
	              ...
	              { text: '委托单位',	dataIndex: 'entrusted_unit', menuDisabled:true, width : 120},
                  { text: '委托日期',	dataIndex: 'date', menuDisabled:true, width : 120},
                  ...
                  { text: '样本数',	dataIndex: 'sample_count', menuDisabled:true, width : 120},
                  ...
                  { text: '合作方',	dataIndex: 'partner', menuDisabled:true, width : 80},
                  { text: '登记人',	dataIndex: 'inputperson', menuDisabled:true, width : 80},
		...
		me.dockedItems = [{
	 		...
	 		style : {
		        ...
		        borderBottomWidth : '0px !important'
		 		...
		 		name:'search',
		 		dock:'top',
		 		items:[drugDetection_starttime,drugDetection_endtime,cancelif,program,inspection]
	 	},{
	 		...
	 		style : {
		        ...
		        borderBottomWidth : '0px !important'
		 		...
		 		name:'search',
		 		dock:'top',
		 		items:[entrusted_unit,sample_type,partner,{
	            	text:'查询',
	            	iconCls:'Find',
	            	handler:me.onSearch
	            }]
...
//		});
	...
	onInsert:function(){
		...
		ownpersonTemp = "";
		confirm_flagTemp="";
		var form = Ext.create("Rds.bacera.form.BaceraDrugDetectionListForm",{
			region:"center",
			grid:me
		});
	...
	drugDetectionExport:function(){
		window.location.href = "bacera/drugDetection/exportDrugDetection.do?"+drugDetection ;
	},
	onDelete:function(){
		var me = this.up("gridpanel");
		...
		Ext.MessageBox.confirm("提示", tempStr+"确认删除选中记录？", function (btn) {
	        if("yes"==btn)
	        {
	    		...
	    		Ext.Ajax.request({  
	    			url:"bacera/drugDetection/delete.do", 
	    			method: "POST",
