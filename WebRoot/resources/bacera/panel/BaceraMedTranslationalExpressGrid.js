...
Ext.define('Rds.bacera.panel.BaceraMedTranslationalExpressGrid', {
	...
	initComponent : function() {
		...
		var medTranslational_starttime = new Ext.form.DateField({
			id:'medTranslational_starttime_express',
			...
			listeners:{
				'select':function(){
					var start = Ext.getCmp('medTranslational_starttime_express').getValue();
	                var endDate = Ext.getCmp('medTranslational_endtime_express').getValue();
	                if (start > endDate) {
	                    Ext.getCmp('medTranslational_starttime_express').setValue(endDate);
	                }
				}
			}
		});
		var medTranslational_endtime = new Ext.form.DateField({
			id:'medTranslational_endtime_express',
...
//			mode: 'SINGLE'
		...
		me.bbar = {xtype: 'label',id:'totalBbarMedTranslationalExamine_express', text: '',style:'height:25px;line-height:25px;text-align:right;margin-right:10px;'};
		me.columns = [
		...
		me.store.on("load",function(){
			Ext.getCmp('totalBbarMedTranslationalExamine_express').setText("共 "+me.store.getCount()+" 条");
		});
	},
	caseCode:function(){
