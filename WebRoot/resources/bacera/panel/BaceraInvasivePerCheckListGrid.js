var verify=""
Ext.define('Rds.bacera.panel.BaceraInvasivePerCheckListGrid', {
		...
		me.store = Ext.create('Ext.data.Store',{
            ...
            listeners:{
            	'beforeload':function(ds, operation, opt){
    				...
    				+ "&invasive_endtime="
    				+ dateformat(verify_endtime.getValue())
            		...
            		Ext.apply(me.store.proxy.params, {num:search.getValue(),name:name.getValue(),ownperson:ownperson.getValue(),
        				...
        				flag:1,
        				areaname:Ext.getCmp('areacodeCheck').getRawValue(),
