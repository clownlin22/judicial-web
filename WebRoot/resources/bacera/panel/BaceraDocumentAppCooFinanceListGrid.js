...
Ext.define('Rds.bacera.panel.BaceraDocumentAppCooFinanceListGrid', {
	...
	initComponent : function() {
		...
		me.store = Ext.create('Ext.data.Store',{
			fields:['id','num','client','phone','client_date','accept_date','appraisal_pro','basic_case','appraisal_end_date','return_type',
			        ...
			        'receivables','payment','paid','discountPrice','paragraphtime','account_type','remittanceName','remittanceDate','finance_remark'],
			proxy: {
                type: 'jsonajax',
                actionMethods:{read:'POST'},
            ...
            listeners:{
            	'beforeload':function(ds, operation, opt){
            		...
            		documentAppCoo = "num=" + num.getValue().trim() + "&client="
							...
							+"&paragraphtime_starttime="
							+ dateformat(paragraphtime_starttime.getValue())
							+"&paragraphtime_endtime="
							+ dateformat(paragraphtime_endtime.getValue())
            		...
            		Ext.apply(me.store.proxy.params, {
            				...
            				cancelif:2,
            				case_close:case_close.getValue(),
            				paragraphtime_starttime:paragraphtime_starttime.getValue(),
            				paragraphtime_endtime:paragraphtime_endtime.getValue(),
            				reportif:reportif.getValue()
    				});
        		}
            }
...
//			mode: 'SINGLE'
       ...
       var pagingToolbar=Ext.getCmp('pagingbarDocumentAppCooFinance');
		...
		me.bbar = Ext.create('Ext.PagingToolbar', {
			id:'pagingbarDocumentAppCooFinance',
			store: me.store,
...
//        });
		...
		me.dockedItems = [{
	        ...
	        borderBottomWidth : '0px !important'
	 		...
	 		name:'search',
	 		dock:'top',
	 		items:[case_close,appraisal_end_starttime,appraisal_end_endtime,reportif]
	 	},{
	 		style : {
	        borderTopWidth : '0px !important',
	        borderBottomWidth : '0px !important'
