...
Ext.define('Rds.bacera.panel.BaceraMedExamineFinanceGrid', {
	...
	initComponent : function() {
		...
		var medExamine_starttime = new Ext.form.DateField({
			id:'medExamine_starttime_finance',
			...
			listeners:{
				'select':function(){
					var start = Ext.getCmp('medExamine_starttime_finance').getValue();
	                var endDate = Ext.getCmp('medExamine_endtime_finance').getValue();
	                if (start > endDate) {
	                    Ext.getCmp('medExamine_starttime_finance').setValue(endDate);
	                }
				}
			}
		});
		var medExamine_endtime = new Ext.form.DateField({
			id:'medExamine_endtime_finance',
		...
		var paragraphtime_starttime = new Ext.form.DateField({
			id:'medExamine_starttime_finance_paragraphtime',
			...
			listeners:{
				'select':function(){
					var start = Ext.getCmp('medExamine_starttime_finance_paragraphtime').getValue();
					var endDate = Ext.getCmp('medExamine_endtime_finance_paragraphtime').getValue();
					if (start > endDate) {
						Ext.getCmp('medExamine_starttime_finance_paragraphtime').setValue(endDate);
					}
				}
			}
		});
		var paragraphtime_endtime = new Ext.form.DateField({
			id:'medExamine_endtime_finance_paragraphtime',
...
//			forceSelection: true, 
		...
		me.store = Ext.create('Ext.data.Store',{
			fields:['id','num','name','program','date','ownpersonname','barcode',
			        ...
			        'age','sex','sampletype','samplecount','hospital',
...
//			mode: 'SINGLE'
		...
		//分页的combobox下拉选择显示条数
	     combo = Ext.create('Ext.form.ComboBox',{
	        ...
	        var pagingToolbar=Ext.getCmp('pagingbarMedExameFinance');
	        ...
	        borderBottomWidth : '0px !important'
	 		...
	 		style : {
		        ...
		        borderBottomWidth : '0px !important'
		 		...
		 		name:'search',
		 		dock:'top',
		 		items:[paragraphtime_starttime,paragraphtime_endtime,barcode,sampletype,sex]
	 	},{
