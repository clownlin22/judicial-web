...
Ext.define('Rds.bacera.panel.BaceraMedScreenFinanceGrid', {
	...
	initComponent : function() {
		...
		var medScreen_starttime = new Ext.form.DateField({
			id:'medScreen_starttime_finance',
			...
			listeners:{
				'select':function(){
					var start = Ext.getCmp('medScreen_starttime_finance').getValue();
	                var endDate = Ext.getCmp('medScreen_endtime_finance').getValue();
	                if (start > endDate) {
	                    Ext.getCmp('medScreen_starttime_finance').setValue(endDate);
	                }
				}
			}
		});
		var medScreen_endtime = new Ext.form.DateField({
			id:'medScreen_endtime_finance',
		...
		var paragraphtime_starttime = new Ext.form.DateField({
			id:'medScreen_starttime_finance_paragraphtime',
			...
			listeners:{
				'select':function(){
					var start = Ext.getCmp('medScreen_starttime_finance_paragraphtime').getValue();
					var endDate = Ext.getCmp('medScreen_endtime_finance_paragraphtime').getValue();
					if (start > endDate) {
						Ext.getCmp('medScreen_starttime_finance_paragraphtime').setValue(endDate);
					}
				}
			}
		});
		var paragraphtime_endtime = new Ext.form.DateField({
			id:'medScreen_endtime_finance_paragraphtime',
...
//			mode: 'SINGLE'
     ...
     var pagingToolbar=Ext.getCmp('pagingbarMedScreenFinance');
...
//		me.bbar = {xtype: 'label',id:'totalBbarMedScreen_finance', text: '',style:'height:25px;line-height:25px;text-align:right;margin-right:10px;'};
		...
		me.dockedItems = [{
	        ...
	        borderBottomWidth : '0px !important'
	 		...
	 		name:'search',
	 		dock:'top',
	 		items:[medScreen_starttime,medScreen_endtime,program,reportif]
	 	},{
	 		style : {
		        borderTopWidth : '0px !important',
		        borderBottomWidth : '0px !important'
