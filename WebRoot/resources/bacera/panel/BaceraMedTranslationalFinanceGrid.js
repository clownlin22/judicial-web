...
Ext.define('Rds.bacera.panel.BaceraMedTranslationalFinanceGrid', {
	...
	initComponent : function() {
		...
		var medTranslational_starttime = new Ext.form.DateField({
			id:'medTranslational_starttime_finance',
			...
			listeners:{
				'select':function(){
					var start = Ext.getCmp('medTranslational_starttime_finance').getValue();
	                var endDate = Ext.getCmp('medTranslational_endtime_finance').getValue();
	                if (start > endDate) {
	                    Ext.getCmp('medTranslational_starttime_finance').setValue(endDate);
	                }
				}
			}
		});
		var medTranslational_endtime = new Ext.form.DateField({
			id:'medTranslational_endtime_finance',
		...
		var paragraphtime_starttime = new Ext.form.DateField({
			id:'medTranslational_starttime_finance_paragraphtime',
			...
			listeners:{
				'select':function(){
					var start = Ext.getCmp('medTranslational_starttime_finance_paragraphtime').getValue();
					var endDate = Ext.getCmp('medTranslational_endtime_finance_paragraphtime').getValue();
					if (start > endDate) {
						Ext.getCmp('medTranslational_starttime_finance_paragraphtime').setValue(endDate);
					}
				}
			}
		});
		var paragraphtime_endtime = new Ext.form.DateField({
			id:'medTranslational_endtime_finance_paragraphtime',
...
//			mode: 'SINGLE'
	    ...
	    var pagingToolbar=Ext.getCmp('pagingbarMedTranslationFinance');
		...
		me.bbar = Ext.create('Ext.PagingToolbar', {
			id:'pagingbarMedTranslationFinance',
			store: me.store,
...
//		me.bbar = {xtype: 'label',id:'totalBbarMedExamine_finance', text: '',style:'height:25px;line-height:25px;text-align:right;margin-right:10px;'};
		...
		me.dockedItems = [{
	        ...
	        borderBottomWidth : '0px !important'
	 		...
	 		name:'search',
	 		dock:'top',
	 		items:[medTranslational_starttime,medTranslational_endtime,program,reportif]
	 	},{
	 		style : {
		        borderTopWidth : '0px !important',
		        borderBottomWidth : '0px !important'
