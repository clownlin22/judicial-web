...
Ext.define('Rds.bacera.panel.BaceraTumorMarkerExpressGrid', {
	...
	initComponent : function() {
		...
		me.store = Ext.create('Ext.data.Store',{
				fields:['id','num','name','inspection','sex','program','paragraphtime','account_type',
				        'expresstype','expressnum','recive','date','ownpersonname','ownperson',
				        'reportif','remark','cancelif','expresstime','remarks','expressremark','areaname','areacode'],
			    proxy: {
                type: 'jsonajax',
            ...
            listeners:{
            	'beforeload':function(ds, operation, opt){
            		...
            		Ext.apply(me.store.proxy.params, {
        				...
        				sex:sex.getValue(),
	    				areaname:Ext.getCmp('areacodeTM3').getRawValue(),
		...
		me.bbar = {xtype: 'label',id:'totalBbarTMF_express', text: '',
		...
		me.dockedItems = [{
	        ...
	        borderBottomWidth : '0px !important'
	 		...
	 		name:'search',
	 		dock:'top',
	 		items:[reportif,TMF_starttime,TMF_endtime]
	 	},{
	 		style : {
		        borderTopWidth : '0px !important',
		...
		me.store.on("load",function(){
			Ext.getCmp('totalBbarTMF_express').setText("共 "+me.store.getCount()+" 条");
		});
	},
	onSearch:function(){
