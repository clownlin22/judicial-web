...
Ext.define('Rds.bacera.panel.BaceraMedThalassemiaExpressGrid', {
	...
	initComponent : function() {
		...
		var medThalassemia_starttime = new Ext.form.DateField({
			id:'medThalassemia_starttime_express',
			...
			listeners:{
				'select':function(){
					var start = Ext.getCmp('medThalassemia_starttime_express').getValue();
	                var endDate = Ext.getCmp('medThalassemia_endtime_express').getValue();
	                if (start > endDate) {
	                    Ext.getCmp('medThalassemia_starttime_express').setValue(endDate);
	                }
				}
			}
		});
		var medThalassemia_endtime = new Ext.form.DateField({
			id:'medThalassemia_endtime_express',
...
//		me.bbar = {xtype: 'label',id:'totalBbarMedThalassemia_express', text: '',style:'height:25px;line-height:25px;text-align:right;margin-right:10px;'};
		me.columns = [
		...
		me.dockedItems = [{
	        ...
	        borderBottomWidth : '0px !important'
	 		...
	 		name:'search',
	 		dock:'top',
	 		items:[medThalassemia_starttime,medThalassemia_endtime,program,reportif,expressnum]
	 	},{
	 		style : {
		        borderTopWidth : '0px !important',
		        borderBottomWidth : '0px !important'
		 		...
		 		name:'search',
		 		dock:'top',
		 		items:[express_starttime,express_endtime,code,{
	            	text:'查询',
	            	iconCls:'Find',
	            	handler:me.onSearch
	            }]
...
//			Ext.getCmp('totalBbarMedThalassemia_express').setText("共 "+me.store.getCount()+" 条");
//		});
	},
	caseCode:function(){
