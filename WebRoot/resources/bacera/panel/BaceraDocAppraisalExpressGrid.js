...
Ext.define('Rds.bacera.panel.BaceraDocAppraisalExpressGrid', {
	...
	initComponent : function() {
		...
		var docAppraisal_starttime = new Ext.form.DateField({
			id:'docAppraisal_starttime_express',
			...
			listeners:{
				'select':function(){
					var start = Ext.getCmp('docAppraisal_starttime_express').getValue();
	                var endDate = Ext.getCmp('docAppraisal_endtime_express').getValue();
	                if (start > endDate) {
	                    Ext.getCmp('docAppraisal_starttime_express').setValue(endDate);
	                }
				}
			}
		});
		var docAppraisal_endtime = new Ext.form.DateField({
			id:'docAppraisal_endtime_express',
