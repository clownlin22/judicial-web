...
Ext.define('Rds.bacera.panel.BaceraDrugDetectionExpressGrid', {
	...
	initComponent : function() {
		...
		var drugDetection_starttime = new Ext.form.DateField({
			id:'drugDetection_starttime_express',
			...
			listeners:{
				'select':function(){
					var start = Ext.getCmp('drugDetection_starttime_express').getValue();
	                var endDate = Ext.getCmp('drugDetection_endtime_express').getValue();
	                if (start > endDate) {
	                    Ext.getCmp('drugDetection_starttime_express').setValue(endDate);
	                }
				}
			}
		});
		var drugDetection_endtime = new Ext.form.DateField({
			id:'drugDetection_endtime_express',
	        ...
	        borderBottomWidth : '0px !important'
	 		...
	 		style : {
		        ...
		        borderBottomWidth : '0px !important'
		 		...
		 		name:'search',
		 		dock:'top',
		 		items:[express_starttime,express_endtime,expressnum,inspection,{
	            	text:'查询',
	            	iconCls:'Find',
	            	handler:me.onSearch
	            }]
...
//			if(i>0&&i%8==0) num +="<br>";
	...
	listeners : {'beforeedit':function(editor, e,s){
