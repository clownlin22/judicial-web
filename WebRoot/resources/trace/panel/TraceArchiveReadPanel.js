 ...
 * @date 20150427
 */
Ext.define("Rds.trace.panel.TraceArchiveReadPanel", {
	...
	initComponent : function() {
		...
		me.store = Ext.create('Ext.data.Store', {
					fields : ['archive_id', 'archive_code', 'case_no',
					...
					proxy : {
						...
						url : 'trace/archive/getArchiveInfo.do',
						params : {},
						reader : {
							type : 'json',
							root : 'items',
		...
		var myGrid = Ext.create('Ext.grid.Panel', {
					...
					store : Ext.create('Ext.data.Store', {
								...
								proxy : {
									...
									url : 'trace/archive/getReadInfo.do',
									params : {},
									reader : {
										type : 'json',
										root : 'data',
	...
	onSave : function() {
		...
		Ext.Ajax.request({
					url : "trace/archive/addReadInfo.do",
					method : "POST",
					headers : {
