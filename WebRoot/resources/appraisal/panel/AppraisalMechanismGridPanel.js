 ...
 * @author yxb
 */
Ext.define("Rds.appraisal.panel.AppraisalMechanismGridPanel", {
	...
	initComponent : function() {
		...
		me.store = Ext.create('Ext.data.Store', {
			...
			proxy : {
				...
				url : 'appraisal/entrust/queryAllPageMechanism.do',
				params : {},
				reader : {
					type : 'json',
					root : 'data',
...
//		return;
		...
		var form = Ext.create("Rds.appraisal.panel.AppraisalMechanismFormPanel",
				{
					region : "center",
					grid : me
				});
	...
	onDelete : function() {
		...
		Ext.MessageBox.confirm("提示", "确认删除选中记录？", function(btn) {
			if ("yes" == btn) {
				Ext.Ajax.request({
					url : "appraisal/entrust/deleteMechanism.do",
					method : "POST",
					headers : {
