...
/**
 * A control that allows selection of between two Rds.ux.form.MultiSelect controls.
 */
Ext.define('Rds.ux.form.ItemSelector', {
    extend: 'Rds.ux.form.MultiSelect',
    alias: ['widget.itemselectorfield', 'widget.itemselector'],
    alternateClassName: ['Rds.ux.ItemSelector'],
    requires: [
        'Ext.button.Button',
        'Rds.ux.form.MultiSelect'
    ],
    ...
    createList: function(title){
        ...
        return Ext.create('Rds.ux.form.MultiSelect', {
