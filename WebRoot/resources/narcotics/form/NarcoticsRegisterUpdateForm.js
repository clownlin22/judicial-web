...
identification_per.load();
Ext.define('Rds.narcotics.form.NarcoticsRegisterUpdateForm', {
                                            ...
                                            listeners: {
                                                'select': function (a, b) {
                                                    ...
                                                    if (choose == 1 ||choose == 0 ) {
                                                        ...
                                                        liquid_color.show();
                                                        ifleakage.show();
                                                        materials_totals.setValue(null);
                                                        materials_color.setValue(null);
                                                        materials_length.setValue(null);
                                                        materials_weight.setValue(null);
                                                        partial_weight.setValue(null);
                                                        ...
                                                        liquid_color.hide();
                                                        ifleakage.hide();
                                                        liquid_color.setValue(null);
                                                        ifleakage.setValue(null);
    ...
    onSave: function () {
        ...
        if (form.isValid()) {
            form.submit({
                url: 'narcotics/register/updateCaseInfo.do',
                method: 'post',
                waitMsg: '正在添加数据...',
    ...
    listeners: {
        'afterrender': function () {
            var identification_materials = Ext.getCmp('identification_materials');
            identification_materials.setValue(this.identification_materials);
            this.changechoose(this.identification_materials);

            var identification_per = Ext.getCmp('identification_per');
            var identification_pers = this.identification_per.split(",");
            identification_per.setValue(identification_pers);
        }
    }
});
