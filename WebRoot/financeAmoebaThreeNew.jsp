...
$(document).ready(function(){
		...
		$.ajax({
			url:'statistics/financeConfigNew/queryAmoebaThree.do',
			type:'get',
			dataType : 'json',
			data:{
...
function jumpToNext(deptname,deptname1){
	window.location.href='/judicial-web/financeAmoebaThree.jsp?deptname=4&deptname1=5';
}
...
function exportAmoeba(){
	...
	window.open("statistics/financeConfigNew/exportAmoebaThree.do?confirm_date_start="+start_time+'-01'+"&confirm_date_end="+end_time+'-31'+"&deptname="+$("#deptname").val());
}
</script>
</head>
