...
$(document).ready(function(){
		...
		$.ajax({
			...
			success:function(data){
				var head = data[0];
				var head_str="<tr><th></th>";
				for(var i = 0 ; i < data[0].length ; i ++)
				{
					head_str +="<th>"+data[0][i]+"</th>";
				}
				head_str+="</tr>";
				$("#head").html(head_str);
				var body_str="";
...
function jumpToNext(deptname){
	window.location.href='/judicial-web/financeAmoebaSecodeNew.jsp?deptname='+deptname
...
function exportAmoeba(){
	...
	window.open("exportAmoeba.do?confirm_date_start="+start_time+'-01'+"&confirm_date_end="+end_time+'-31');
}
</script>
</head>
