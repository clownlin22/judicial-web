    ...
    <c:forEach items="${caseModel.results}" var="type" >
             <div class="page">
		      ...
		      <c:if test="${not empty caseModel.accept_time|| caseModel.accept_time!=''}">
				          南京东南司法鉴定中心[<c:out value="${fn:substring(caseModel.accept_time, 0, 4)}" />]
		      法物鉴字第${caseModel.case_code}号
		      </c:if>
		      <c:if test="${empty caseModel.accept_time|| caseModel.accept_time =='' }"> 
					南京东南司法鉴定中心[<c:out value="${fn:substring(caseModel.addextnew_time, 0, 4)}" />]
		      法物鉴字第${caseModel.case_code}号
			  </c:if> 
			   </div>
		      ...
		      <c:if test="${empty caseModel.accept_time|| caseModel.accept_time =='' }"> 
		          ...
		          <div class="spanel"><span class="p_title">检验材料：</span>1：${type.sampleModel.father_info.sample_username}的${type.sampleModel.father_info.sample_typename}（编号：${type.sampleModel.father_info.sample_code}）<c:if test="${type.sampleModel.mother_info.sample_code!=''&&type.sampleModel.mother_info.sample_code!=null}"><div class="p_no">2：${type.sampleModel.mother_info.sample_username}的${type.sampleModel.mother_info.sample_typename}（编号：${type.sampleModel.mother_info.sample_code}）</div></c:if>
		          ...
		          <div class="spanel"><span class="p_title">被检验人：</span>${type.sampleModel.father_info.sample_callname}—${type.sampleModel.father_info.sample_username}<c:if test="${type.sampleModel.father_info.sample_callname=='父亲'}">（男</c:if><c:if test="${type.sampleModel.father_info.sample_callname=='母亲'}">（女</c:if><c:if test="${type.sampleModel.father_info.id_number!=''&&type.sampleModel.father_info.id_number!=null}">,身份证号: ${type.sampleModel.father_info.id_number }</c:if><c:if test="${fn:trim(type.sampleModel.father_info.id_number)==''&&type.sampleModel.father_info.birth_date_format!=null&&fn:trim(type.sampleModel.father_info.birth_date_format)!=''}">,出生日期: ${type.sampleModel.father_info.birth_date_format}</c:if>）<c:if test="${type.sampleModel.mother_info.sample_code!=''&&type.sampleModel.mother_info.sample_code!=null}"><div class="p_no">${type.sampleModel.mother_info.sample_callname}—${type.sampleModel.mother_info.sample_username}<c:if test="${type.sampleModel.mother_info.sample_callname=='父亲'}">（男</c:if><c:if test="${type.sampleModel.mother_info.sample_callname=='母亲'}">（女</c:if><c:if test="${type.sampleModel.mother_info.id_number!=''&&type.sampleModel.mother_info.id_number!=null}">,身份证号: ${type.sampleModel.mother_info.id_number}</c:if><c:if test="${fn:trim(type.sampleModel.mother_info.id_number)==''&&type.sampleModel.mother_info.birth_date_format!=null&&fn:trim(type.sampleModel.mother_info.birth_date_format)!=''}">,出生日期: ${type.sampleModel.mother_info.birth_date_format}</c:if>）</div>												  																  </c:if>		
		      ...
		      <c:if test="${empty caseModel.accept_time|| caseModel.accept_time =='' }"> 
		          ...
		          <div class="spanel  intent"><span class="p_title">检验地点：</span>南京东南司法鉴定中心</div>
		          <div class="panel_title">二、检案摘要</div>
		          <div class="pageem content paragraph">
		           ${type.sampleModel.father_info.sample_username}<c:if test="${type.sampleModel.mother_info.sample_code!=''&&type.sampleModel.mother_info.sample_code!=null}">和${type.sampleModel.mother_info.sample_username}</c:if>因申报户口需要明确其本人是否是${type.sampleModel.child_info.sample_username}的生物学<c:if test="${type.sampleModel.mother_info.sample_code!=''&&type.sampleModel.mother_info.sample_code!=null}">父母</c:if><c:if test="${type.sampleModel.mother_info.sample_code==''||type.sampleModel.mother_info.sample_code==null}">${type.sampleModel.father_info.sample_callname}</c:if>,故委托本所进行检验。
		          </div>
		          <div class="panel_title">三、检验过程</div>
		          <div class="pageem content paragraph">1.参照《法庭科学&ensp;DNA&ensp;实验室检验规范》（GA/T&ensp;383-2002）中 Chelex-100法提取上述检材的DNA。 </div>
		          <div class="pageem content paragraph">2.取上述检材的DNA提取产物适量，用荧光标记STR复合扩增试剂盒MICROREADER<sup>TM</sup>进行10μL体系PCR扩增（操作步骤按试剂盒说明），并设立阴性及阳性对照。</div>
		    ...
		    <c:if test="${type.result_type=='passed_3'}">
		      ...
		      法物鉴字第${caseModel.case_code}号
				         ...
				         <div class="pageem content first-content">
				          ...
				          <div class="page_center">19-STR基因座分型结果表</div>
		      ...
		      法物鉴字第${caseModel.case_code}号
				         ...
				         <hr/>
					        <div class="pageem content paragraph">
					            D19S433等19个STR基因座均为人类的遗传学标记，遵循孟德尔遗传定律，联合应用可进行亲权鉴定。上述19个STR基因座检测结果显示：${type.sampleModel.child_info.sample_username}的等位基因可从${type.sampleModel.father_info.sample_username}和${type.sampleModel.mother_info.sample_username}的基因型中找到来源。经计算,累积亲权指数大于10000。
					          </div>
					        <div class="pageem content paragraph">
		     ...
		     <c:if test="${type.result.compareResultModel.ext_flag=='Y'}">
		      ...
		      法物鉴字第${caseModel.case_code}号
				         ...
				         <hr/>
				          ...
				          <div class="page_center">38-STR基因座分型结果表</div>
		      ...
		      法物鉴字第${caseModel.case_code}号
		                 ...
		                 <div class="pageem content paragraph" style="margin-top: 40px;">
		                     D19S433等38个STR基因座均为人类的遗传学标记，遵循孟德尔遗传定律，联合应用可进行亲权鉴定。上述38个STR基因座检测结果显示：除${type.result.compareResultModel.unmatched_node}基因座以外，${type.sampleModel.child_info.sample_username}的等位基因可从${type.sampleModel.father_info.sample_username}和${type.sampleModel.mother_info.sample_username}的基因型中找到来源。经计算，累积亲权指数大于10000。
		                 </div>
				   </div>
				   <div class="page">
				          <div class="page_title_name">
		     ...
		     <c:if test="${type.result_type=='passed_2'}">
		      ...
		      法物鉴字第${caseModel.case_code}号
				         ...
				         <hr/>
					          <div class="pageem content paragraph">
					            D19S433等19个STR基因座均为人类的遗传学标记，遵循孟德尔遗传定律，联合应用可进行亲权鉴定。上述19个STR基因座检测结果显示:${type.sampleModel.child_info.sample_username}的等位基因可从${type.sampleModel.father_info.sample_username}的基因型中找到来源。经计算，累积亲权指数为${type.result.pi},即${type.sampleModel.father_info.sample_username}为${type.sampleModel.child_info.sample_username}生物学${type.sampleModel.father_info.sample_callname}的可能性是无关<c:if test="${type.sampleModel.father_info.sample_callname=='父亲'}">男</c:if><c:if test="${type.sampleModel.father_info.sample_callname=='母亲'}">女</c:if>性个体为${type.sampleModel.child_info.sample_username}生<c:if test="${type.sampleModel.father_info.sample_callname=='父亲'}">父</c:if><c:if test="${type.sampleModel.father_info.sample_callname=='母亲'}">母</c:if>可能性的${type.result.pi }倍。
					          </div>
					          <div class="pageem content paragraph">
				         ...
				         <hr/>
				          ...
				          <c:forEach items="${type.sampleModel.sampleResults}" var="list" varStatus="status" begin="20" step="1"><tr>
				            ...
				            <c:if test="${type.result.compareResultModel.unmatched_count>0}">
				                       <div class="pageem content paragraph">
							             D19S433等38个STR基因座均为人类的遗传学标记，遵循孟德尔遗传定律，联合应用可进行亲权鉴定。上述38个STR基因座检测结果显示：除${type.result.compareResultModel.unmatched_node}基因座以外，${type.sampleModel.child_info.sample_username}的等位基因可从${type.sampleModel.father_info.sample_username}的基因型中找到来源。
							          </div>
				              </c:if>
				              <c:if test="${type.result.compareResultModel.unmatched_count==0}">
				                       <div class="pageem content paragraph">
							             D19S433等38个STR基因座均为人类的遗传学标记，遵循孟德尔遗传定律，联合应用可进行亲权鉴定。上述38个STR基因座检测结果显示：${type.sampleModel.child_info.sample_username}的等位基因可从${type.sampleModel.father_info.sample_username}的基因型中找到来源。
							          </div>
				              </c:if>
				        </div>
				        <div class="page">
		      ...
		      法物鉴字第${caseModel.case_code}号
					         ...
					         <hr/>
						          <div class="pageem content paragraph">
						            D19S433等19个STR基因座均为人类的遗传学标记，遵循孟德尔遗传定律，联合应用可进行亲权鉴定。上述19个STR基因座检测结果显示：${type.sampleModel.child_info.sample_username}在${type.result.compareResultModel.unmatched_node}基因座上的等位基因不能从${type.sampleModel.father_info.sample_username}的基因型中找到来源。
						          </div>
						          <div class="pageem content paragraph">
					      ...
					      <c:if test="${type.result.compareResultModel.ext_flag=='Y'}"> 
					         <div class="page">
						          <div class="page_title_name">
						          <c:if test="${not empty caseModel.accept_time|| caseModel.accept_time!=''}">
				            宿迁子渊司法鉴定所[<c:out value="${fn:substring(caseModel.accept_time, 0, 4)}" />]
			  法物鉴字第${caseModel.case_code}号 
		      </c:if>
		      <c:if test="${empty caseModel.accept_time|| caseModel.accept_time =='' }"> 
					  宿迁子渊司法鉴定所[<c:out value="${fn:substring(caseModel.addextnew_time, 0, 4)}" />]
			  法物鉴字第${caseModel.case_code}号 
			  </c:if> 
			</div>
			  ...
			  法物鉴字第${caseModel.case_code}号 
					         ...
					         <table class="table border_no_top" cellSpacing="0" border="solid" cellPadding="0">
				                <c:forEach items="${type.sampleModel.sampleResults}" var="list" varStatus="status" begin="20" step="1"><tr>
						          ...
						          <div class="pageem content paragraph">
						            D19S433等38个STR基因座均为人类的遗传学标记，遵循孟德尔遗传定律，联合应用可进行亲权鉴定。上述38个STR基因座检测结果显示：${type.sampleModel.child_info.sample_username}在${type.result.compareResultModel.unmatched_node}基因座上的等位基因不能从${type.sampleModel.father_info.sample_username}的基因型中找到来源。
						          </div>
						          <div class="pageem content paragraph">
						                     依据现有资料和DNA分析结果，排除${type.sampleModel.father_info.sample_username}是${type.sampleModel.child_info.sample_username}的生物学${type.sampleModel.father_info.sample_callname}。
						          </div> 
