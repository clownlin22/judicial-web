    ...
    <c:forEach items="${caseModel.results}" var="type" >
             <div class="page">
		      ...
		      <c:if test="${empty caseModel.accept_time|| caseModel.accept_time =='' }"> 
		          ...
		          <div class="pageem content paragraph">2.取上述检材的DNA提取产物适量，用21plex荧光标记STR复合扩增试剂盒（江苏苏博生物医学科技南京有限公司）进行10μL体系PCR扩增（操作步骤按试剂盒说明），并设立阴性及阳性对照。</div>
		          <c:if test="${type.sampleModel.mother_info.sample_code==''||type.sampleModel.mother_info.sample_code==null}">
					 ...
					 宿迁子渊司法鉴定所[<c:out value="${fn:substring(caseModel.addextnew_time, 0, 4)}" />]
				         ...
				         <div class="pageem content first-content">
				          ...
				          <table class="table_3" cellSpacing="0" border="solid" cellPadding="0">
				             <tr><th style="width:37%">案号：${caseModel.case_code}<div class="no_margin">委托人：${caseModel.client}</div><div class="no_margin">
