<%@page import="com.rds.judicial.model.RdsJudicialPrintCaseModel"%>
    ...
    <c:forEach items="${caseModel.results}" var="type" >
             <div class="page">
			  ...
			  法物鉴字第${caseModel.case_code}号 
		          ...
		          <div class="spanel"><span class="p_title">委托鉴定事项：</span><c:if test="${type.sampleModel.mother_info.sample_code!=''&&type.sampleModel.mother_info.sample_code!=null}">${type.sampleModel.father_info.sample_username}和${type.sampleModel.mother_info.sample_username}是否是${type.sampleModel.child_info.sample_username}的生物学父母</c:if><c:if test="${type.sampleModel.mother_info.sample_code==''||type.sampleModel.mother_info.sample_code==null}">${type.sampleModel.father_info.sample_username}是否是${type.sampleModel.child_info.sample_username}的生物学${type.sampleModel.father_info.sample_callname}</c:if></div>
		      ...
		      <c:if test="${empty caseModel.accept_time|| caseModel.accept_time =='' }"> 
		          ...
		          <div class="spanel"><span class="p_title">鉴定材料：</span>1：${type.sampleModel.father_info.sample_username}的${type.sampleModel.father_info.sample_typename}（编号：${type.sampleModel.father_info.sample_code}）
		          ...
		          <div class="spanel"><span class="p_title">被鉴定人：</span>${type.sampleModel.father_info.sample_callname}—${type.sampleModel.father_info.sample_username}<c:if test="${type.sampleModel.father_info.sample_callname=='父亲'}">（男</c:if><c:if test="${type.sampleModel.father_info.sample_callname=='母亲'}">（女</c:if><c:if test="${type.sampleModel.father_info.id_number!=''&&type.sampleModel.father_info.id_number!=null}">,身份证号: ${type.sampleModel.father_info.id_number }</c:if><c:if test="${fn:trim(type.sampleModel.father_info.id_number)==''&&type.sampleModel.father_info.birth_date_format!=null&&fn:trim(type.sampleModel.father_info.birth_date_format)!=''}">,出生日期: ${type.sampleModel.father_info.birth_date_format}</c:if>）
		      ...
		      <c:if test="${empty caseModel.accept_time|| caseModel.accept_time =='' }"> 
		          ...
		          <div class="panel_title">三、鉴定过程</div>
...
<c:if test="${not empty caseModel.accept_time|| caseModel.accept_time!=''}">
			  ...
			  法物鉴字第${caseModel.case_code}号 
				         ...
				         <div class="pageem content first-content">
				          ...
				          <div class="page_center">21-STR基因座分型结果表</div>
		      ...
		      <c:if test="${empty caseModel.accept_time|| caseModel.accept_time =='' }"> 
					受理日期：${caseModel.addextnew_time}
				             ...
				             <c:forEach items="${type.sampleModel.sampleResults}" var="list" begin="0" end="20" step="1"><tr>
...
<c:if test="${not empty caseModel.accept_time|| caseModel.accept_time!=''}">
			  ...
			  法物鉴字第${caseModel.case_code}号 
				         ...
				         <hr/>
					        <div class="pageem content paragraph">
					            D19S433等21个STR基因座均为人类的遗传学标记，遵循孟德尔遗传定律，联合应用可进行亲权鉴定。上述21个STR基因座检测结果显示：${type.sampleModel.child_info.sample_username}的等位基因可从${type.sampleModel.father_info.sample_username}和${type.sampleModel.mother_info.sample_username}的基因型中找到来源。经计算,累积亲权指数大于10000。
					          </div>
					        <div class="pageem content paragraph">
...
<c:if test="${not empty caseModel.accept_time|| caseModel.accept_time!=''}">
			  ...
			  法物鉴字第${caseModel.case_code}号 
				         ...
				         <hr/>
				          ...
				          <div class="page_center">40-STR基因座分型结果表</div>
		      ...
		      <c:if test="${empty caseModel.accept_time|| caseModel.accept_time =='' }"> 
					 受理日期：${caseModel.addextnew_time}
				           ...
				           <tr><td style="width:37%;border-bottom: solid 1px;font-weight: bold;">基因位点</td><td colspan="3" style="border-bottom: solid 1px;font-weight: bold;">等位基因</td></tr>
				             <c:forEach items="${type.sampleModel.sampleResults}" var="list" varStatus="status" begin="0" end="20" step="1"><tr><c:forEach items="${list}" var="map">
				                       <c:choose>  
										   <c:when test="${map.key=='name'}">
										       <td style="width:37%">${map.value}</td>
										   </c:when>  
			  ...
			  法物鉴字第${caseModel.case_code}号 
				         ...
				         <hr/>
						  ...
						  <c:forEach items="${type.sampleModel.sampleResults}" var="list" varStatus="status" begin="21" step="1"><tr>
						  <c:forEach items="${list}" var="map">
				                       <c:choose>  
										   <c:when test="${map.key=='name'}">
										       <td style="width:37%">${map.value}</td>
		                 ...
		                 <div class="pageem content paragraph" style="margin-top: 40px;">
		                     D19S433等40个STR基因座均为人类的遗传学标记，遵循孟德尔遗传定律，联合应用可进行亲权鉴定。上述40个STR基因座检测结果显示：除${type.result.compareResultModel.unmatched_node}基因座以外，${type.sampleModel.child_info.sample_username}的等位基因可从${type.sampleModel.father_info.sample_username}和${type.sampleModel.mother_info.sample_username}的基因型中找到来源。经计算，累积亲权指数大于10000。
		                 </div>
				   </div>
				   <div class="page">
				          <div class="page_title_name">
...
<c:if test="${not empty caseModel.accept_time|| caseModel.accept_time!=''}">
			  ...
			  法物鉴字第${caseModel.case_code}号 
				         ...
				         <div class="pageem content first-content">
				          ...
				          <table class="table" cellSpacing="0" border="solid" cellPadding="0">
				             ...
				             <c:forEach items="${type.sampleModel.sampleResults}" var="list" varStatus="status" begin="0" end="20" step="1"><tr>
				                  <c:forEach items="${list}" var="map">
										<c:choose>  
										   <c:when test="${map.key=='name'}">
										       <td>${map.value}</td>
			  ...
			  法物鉴字第${caseModel.case_code}号 
				         ...
				         <hr/>
					          <div class="pageem content paragraph">
					            D19S433等21个STR基因座均为人类的遗传学标记，遵循孟德尔遗传定律，联合应用可进行亲权鉴定。上述21个STR基因座检测结果显示:${type.sampleModel.child_info.sample_username}的等位基因可从${type.sampleModel.father_info.sample_username}的基因型中找到来源。经计算，累积亲权指数为${type.result.pi},即${type.sampleModel.father_info.sample_username}为${type.sampleModel.child_info.sample_username}生物学${type.sampleModel.father_info.sample_callname}的可能性是无关<c:if test="${type.sampleModel.father_info.sample_callname=='父亲'}">男</c:if><c:if test="${type.sampleModel.father_info.sample_callname=='母亲'}">女</c:if>性个体为${type.sampleModel.child_info.sample_username}生<c:if test="${type.sampleModel.father_info.sample_callname=='父亲'}">父</c:if><c:if test="${type.sampleModel.father_info.sample_callname=='母亲'}">母</c:if>可能性的${type.result.pi }倍。
					          </div>
					          <div class="pageem content paragraph">
				         ...
				         <hr/>
				          ...
				          <c:forEach items="${type.sampleModel.sampleResults}" var="list" varStatus="status" begin="21" step="1"><tr>
				                  <c:forEach items="${list}" var="map">
										   ...
										   </c:otherwise></c:choose></c:forEach></tr></c:forEach>
				          </table>
				            <c:if test="${type.result.compareResultModel.unmatched_count>0}">
				                       <div class="pageem content paragraph">
							             D19S433等40个STR基因座均为人类的遗传学标记，遵循孟德尔遗传定律，联合应用可进行亲权鉴定。上述40个STR基因座检测结果显示：除${type.result.compareResultModel.unmatched_node}基因座以外，${type.sampleModel.child_info.sample_username}的等位基因可从${type.sampleModel.father_info.sample_username}的基因型中找到来源。
							          </div>
				              </c:if>
				              <c:if test="${type.result.compareResultModel.unmatched_count==0}">
				                       <div class="pageem content paragraph">
							             D19S433等40个STR基因座均为人类的遗传学标记，遵循孟德尔遗传定律，联合应用可进行亲权鉴定。上述40个STR基因座检测结果显示：${type.sampleModel.child_info.sample_username}的等位基因可从${type.sampleModel.father_info.sample_username}的基因型中找到来源。
							          </div>
				              </c:if>
				        </div>
				        <div class="page">
...
<c:if test="${not empty caseModel.accept_time|| caseModel.accept_time!=''}">
			  ...
			  法物鉴字第${caseModel.case_code}号 
					         ...
					         <hr/>
						          <div class="pageem content paragraph">
						            D19S433等21个STR基因座均为人类的遗传学标记，遵循孟德尔遗传定律，联合应用可进行亲权鉴定。上述21个STR基因座检测结果显示：${type.sampleModel.child_info.sample_username}在${type.result.compareResultModel.unmatched_node}基因座上的等位基因不能从${type.sampleModel.father_info.sample_username}的基因型中找到来源。
						          </div>
						          <div class="pageem content paragraph">
			  ...
			  法物鉴字第${caseModel.case_code}号 
					         ...
					         <table class="table border_no_top" cellSpacing="0" border="solid" cellPadding="0">
				                <c:forEach items="${type.sampleModel.sampleResults}" var="list" varStatus="status" begin="21" step="1"><tr>
						          ...
						          <div class="pageem content paragraph">
						            D19S433等40个STR基因座均为人类的遗传学标记，遵循孟德尔遗传定律，联合应用可进行亲权鉴定。上述40个STR基因座检测结果显示：${type.sampleModel.child_info.sample_username}在${type.result.compareResultModel.unmatched_node}基因座上的等位基因不能从${type.sampleModel.father_info.sample_username}的基因型中找到来源。
						          </div>
						          <div class="pageem content paragraph">
						                     依据现有资料和DNA分析结果，排除${type.sampleModel.father_info.sample_username}是${type.sampleModel.child_info.sample_username}的生物学${type.sampleModel.father_info.sample_callname}。
						          </div> 
