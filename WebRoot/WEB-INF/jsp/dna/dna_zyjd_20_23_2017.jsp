		    ...
		    <c:if test="${type.result_type=='passed_3'}">
		      ...
		      <c:if test="${empty caseModel.accept_time|| caseModel.accept_time =='' }"> 
					受理日期：${caseModel.addextnew_time}
				          ...
				          <c:forEach items="${type.sampleModel.sampleResults}" var="list" begin="0" end="18" step="1"><tr><c:forEach items="${list}" var="map">
				                       <c:choose>  
		      ...
		      <c:if test="${empty caseModel.accept_time|| caseModel.accept_time =='' }"> 
					 宿迁子渊司法鉴定所[<c:out value="${fn:substring(caseModel.addextnew_time, 0, 4)}" />]法物鉴字第${caseModel.case_code}号 
				         ...
				         <hr/>
					        ...
					        <div class="pageem content paragraph">
					            D19S433等19个STR基因座均为人类的遗传学标记，遵循孟德尔遗传定律，联合应用可进行亲权鉴定，其累积非父排除概率大于0.9999。
					          </div>
					           <div class="pageem content paragraph">
		      ...
		      <c:if test="${empty caseModel.accept_time|| caseModel.accept_time =='' }"> 
					 宿迁子渊司法鉴定所[<c:out value="${fn:substring(caseModel.addextnew_time, 0, 4)}" />]法物鉴字第${caseModel.case_code}号 
		                 ...
		                 <div class="pageem content paragraph" style="margin-top: 40px;">
		                     D19S433等38个STR基因座均为人类的遗传学标记，遵循孟德尔遗传定律，联合应用可进行亲权鉴定，其累积非父排除概率大于0.9999。
		                 </div>
		                 <div class="pageem content paragraph" style="margin-top: 40px;">
		      ...
		      <c:if test="${empty caseModel.accept_time|| caseModel.accept_time =='' }"> 
					 宿迁子渊司法鉴定所[<c:out value="${fn:substring(caseModel.addextnew_time, 0, 4)}" />]法物鉴字第${caseModel.case_code}号 
				         ...
				         <div class="pageem content first-content">
				          ...
				          <div class="page_center">19-STR基因座分型结果表</div><table class="table" cellSpacing="0" border="solid" cellPadding="0">
		      ...
		      <c:if test="${empty caseModel.accept_time|| caseModel.accept_time =='' }"> 
					 宿迁子渊司法鉴定所[<c:out value="${fn:substring(caseModel.addextnew_time, 0, 4)}" />]法物鉴字第${caseModel.case_code}号 
				         ...
				         <hr/>
					          <div class="panel_title">五、分析说明</div>
					          <div class="pageem content paragraph">
					            D19S433等19个STR基因座均为人类的遗传学标记，遵循孟德尔遗传定律，联合应用可进行亲权鉴定。</div>
					          <div class="pageem content paragraph">
