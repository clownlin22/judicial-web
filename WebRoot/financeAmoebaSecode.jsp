...
$(document).ready(function(){
		...
		$.ajax({
			url:'statistics/financeConfig/queryAmoebaSecond.do',
			type:'get',
			dataType : 'json',
			data:{
...
function exportAmoeba(){
	...
	window.open("statistics/financeConfig/exportAmoebaSecond.do?confirm_date_start="+start_time+'-01'+"&confirm_date_end="+end_time+'-31'+"&deptname="+$("#deptname").val());
}
</script>
</head>
