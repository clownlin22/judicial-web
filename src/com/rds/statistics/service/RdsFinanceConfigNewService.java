...
public interface RdsFinanceConfigNewService {
	...
	List<List<String>> queryAmoebaThree(Map<String, Object> params);

	void exportAmoebaThree(Map<String, Object> params, HttpServletResponse response);
