...
@Component("RdsBaceraDocAppraisalMapper")
public interface RdsBaceraDocAppraisalMapper extends RdsBaceraBaseMapper {
	...
	public boolean deleteFinanceTax(String id);
}
