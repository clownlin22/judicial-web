...
@Component("RdsJudicialDicValuesMapper")
public interface RdsJudicialDicValuesMapper extends RdsJudicialBaseMapper{
	...
	List<RdsUpcPermitNodeModel> getReportType(String usercode);
